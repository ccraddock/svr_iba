...
foreach my $dir (sort @dirs)
{
    if((-d $dir ) and ($dir =~ m/CCB(\w*)_scan(\d+)_(\d+)/))
    {
        ...
        foreach my $censor (@censors)
        {
            ...
            {
                open(OFILE,">$ff"."_$censor"."_$dset"."_svrfc_part.sh") or die "could not open $ff"."_$censor"."_$dset"."_svrfc_part.sh for writing";
                print OFILE "export PATH=/home/drcc/netspace/afni_bin:\$PATH\n"; 
                print OFILE "export AFNI_COMPRESSOR=GZIP\n";
                print OFILE "cd $dir\n"; 
                print OFILE "time $pwd/fc_svr_part.sh \${PWD} $dset $pwd/$censor.1D > $ff"."_$censor"."_$dset"."_svrfc_part.log 2>&1\n";
                close(OFILE);
                chmod 0755, "$ff"."_$censor"."_$dset"."_svrfc_part.sh";

                open(PFILE,">$ff"."_$censor"."_$dset"."_svrfc_part.pbs") or die "could not open $ff"."_$censor"."_$dset"."_svrfc_part.pbs for writing";
                ...
                print PFILE "#PBS -l walltime=4:00:00\n";
                print PFILE "#PBS -l nodes=1:ppn=2\n";
                print PFILE "### Output files\n";
                print PFILE "### Output files\n";
                print PFILE "#PBS -e $ff"."_$censor"."_$dset"."_svrfc.err\n";
                print PFILE "#PBS -o $ff"."_$censor"."_$dset"."_svrfc.log\n";
                ...
                print PFILE "$pwd/$ff"."_$censor"."_$dset"."_svrfc_part.sh\n";
